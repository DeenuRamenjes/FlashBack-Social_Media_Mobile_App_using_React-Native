  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.profileInfo}>
          ...
          <View style={styles.avatarAndStats}>
            ...
            <View style={styles.actionButtons}>
              <TouchableOpacity style={styles.editButton} onPress={()=>setIsEditModeVisible(true)}>
      ...
      {/* Select Profile Model */}
          <Modal
            visible={isEditModeVisible}
            animationType='fade'
            transparent={true}
            onRequestClose={()=>setIsEditModeVisible(false)}
          >
              ...
              >
                <View style={styles.modalContent}>
                  <View style={styles.modalHeader}>
                    ...
                    <TouchableOpacity onPress={()=>setIsEditModeVisible(false)}>
